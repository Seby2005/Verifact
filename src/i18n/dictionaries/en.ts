...
export const en: Translations = {
  ...
  auditTrail: {
    ...
    bylineLabel: 'Transparency Byline: ',
    byline:
      'Analysis generated automatically by Verifact Core v1.0 • Evaluated against open public sources • Published at {date}.',
    ...
    pipelineTitle: 'Multi-Layer Pipeline Coverage',
    layer1: '1. Fact-Check Databases',
    layer2: '2. Credible News Media',
    layer3: '3. Official & Public Records',
    layer4: '4. Social Propagation Context',
    unitMatches: 'matches',
    unitArticles: 'articles',
    unitRecords: 'records',
    unitSignals: 'signals',
    uniqueId: 'Verification Unique ID:',
  },
  publicReports: {
