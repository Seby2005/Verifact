...
export default function DespreDezinformarePage() {
  ...
  const content = isEn
    ...
    : {
        ...
        everydayText2:
          'Corectează în privat, nu în fața unui public; pornește de la o sursă, nu de la un verdict; și nu-l face pe om să se simtă prost că a crezut — asta doar îl împinge să apere afirmația. Scopul nu e să câștigi cearta, ci ca toți să plece puțin mai bine informați.',
        closingText: 'Nu ești sigur de ceva ce ai văzut? ',
