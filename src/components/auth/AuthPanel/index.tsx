...
export const AuthPanel: React.FC = () => {
  ...
  return (
    <section className={styles.panel} aria-labelledby="auth-heading">
      ...
      {/* Google Identity Services — the native Google popup, not a redirect to
          the supabase.co consent screen. */}
      <div className={styles.socialButtons}>
        <GoogleSignInButton onError={(message) => setStatus({ state: 'error', message })} />
      </div>
